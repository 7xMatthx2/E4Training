...
/**
 * This is the item provider adapter for a {@link com.sii.airline.airline.Employee} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EmployeeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AirlinePackage.Literals.EMPLOYEE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addAdressPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Employee_adress_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Employee_adress_feature", "_UI_Employee_type"),
				 AirlinePackage.Literals.EMPLOYEE__ADRESS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Employee.class)) {
			case AirlinePackage.EMPLOYEE__NAME:
			case AirlinePackage.EMPLOYEE__ADRESS:
